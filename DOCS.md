...
| Editable Blender sources and warehouse integration for all sixteen critters, source checks and pending native verification | `design/astra/DREAM_CRITTER_BLENDER_REBUILD_2026-09-19.md` *(INERT implementation report)* |
