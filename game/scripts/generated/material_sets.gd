...
const SETS := {
	'plaster_stained': ["T_ai_materials_plaster_stained_albedo.png", "T_ai_materials_plaster_stained_rough.png", "T_ai_materials_plaster_stained_normal.png", 1.8, 0],
	'floor_oak': ["T_ai_materials_floor_oak_albedo.png", "T_ai_materials_floor_oak_rough.png", "T_ai_materials_floor_oak_normal.png", 2.7, 0],
