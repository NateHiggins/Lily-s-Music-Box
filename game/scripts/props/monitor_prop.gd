...
##
## The marker and class keep the old `monitor` name because they are binding
## keys: the call runner, acoustic graph and virus director already address
## F04_B_MONITOR_01.  Visually it is no longer two modern flat panels. It is a
