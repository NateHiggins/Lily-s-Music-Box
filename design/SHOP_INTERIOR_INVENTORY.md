...
| Pawnbroker | two display cases, nine static clocks, grilled counter, receiving cabinet | **Retain** cases and grille. **Keep clocks static** and reuse the reviewed family’s proportions/material language. **Add** unredeemed parcel-wall hero, brass wicket, balance, loupe, safe, pledge ledger and specific non-precious pledges. |
...
| Photo Supplies | glazed counter, film boxes, enlargers, darkroom door/lamp, receiving cabinet | **Retain** darkroom hero and high enlargers. **Add** three period camera silhouettes, plates/film by size, tanks, trays, print dryer, tripod rack, flash-powder tins, portrait display, unclaimed-portrait rack and ledger. |
