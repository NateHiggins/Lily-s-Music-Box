...
- Rooms: 16; doors: 29; unassigned records: 4396
- Art faces: 49; frame-like records: 23
...
| F01_STORAGE_C | storage | — | 7 | 3 | 3 | kind only |
...
| F01_PACKAGE | storage | — | 10 | 3 | 5 | kind only |
...
- `furniture` `common_cab`: (-13.1, 7.85)
- `furniture` `common_stack1`: (-13.025, 9.075000000000001)
...
| F04_B_MAIN | living | 4B | 22 | 6 | 7 | kind only |
