...
| 16 | **Audio cue captions** | `game/data/audio_cues.json` `caption` ×23 | data | opt-in overlay, **yes** | the house | object copy | none | canonical | **high** | **yes — data** | **accessibility** | **none** | keep | — | audio policy |
