...
func _run() -> void:
	...
	_check("full override cache source remains unbound", not cached.has_meta("living_storey")
			and cached.get_shader_parameter("has_living") != true)
	...
	_check("inactive surface beneath a full override is not registered", hidden_surface.get_shader_parameter("has_living") != true
	...
	_check("storey scan excludes cabinet world", private_draw.material_override == private_material
			and private_material.get_shader_parameter("has_living") != true)
	_check("storey scan excludes residents and player", resident_draw.material_override == resident_material
			...
			and resident_material.get_shader_parameter("has_living") != true)
