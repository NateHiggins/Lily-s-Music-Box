...
# V2 placements, retaining the original 4B bed footprint dimensions and cool bedding.
PLACEMENTS=[('4B_wake_bed','F04_B_ALCOVE',[-13.1,0,8.9],0,[-11.95,0,8.9]),
            ('4B_wake_nightstand','F04_B_ALCOVE',[-12.05,0,9.95],0,[-11.95,0,8.9])]
...
def generate():
    ...
    records=json.loads((OUT/'specs.json').read_text())
    furniture=[]
