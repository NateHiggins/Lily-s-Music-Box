...
BASE='80262a365e9dcf421f3546a2637eb94e4576d8ad'
...
boxes=[]
placements={r['id']:r for r in read('design/astra/work/v2_f03_furniture_01/placements.json')}
...
owned={'F03_B_REPAIR_STANCE','F03_3B_SINK_01_STANCE','F03_3B_SINK_01_CAPSULE','F03_B_REPAIR_USE'}
...
assert len(layout['anchors'])==len(old['anchors'])+6
assert len(layout['capsule_stations'])==len(old['capsule_stations'])+3
paths=['game/data/orison_v2/domestic_furniture.json','game/data/orison_v2_blockout.json',
 'game/scripts/building/orison_v2_domestic_furniture.gd','game/scripts/building/orison_v2_water_closet.gd',
 'game/scripts/building/orison_v2_runtime_root.gd','game/tests/orison_v2_connected_world_test.gd']
...
receipt=dict(status='SOURCE_CHECKS_PASS_NATIVE_UNRUN',base_head=BASE,native_godot_started=False,
 ...
 'named anchor transforms','older layout preservation except four owned adjustments','GDScript syntax','protected source unchanged'],
