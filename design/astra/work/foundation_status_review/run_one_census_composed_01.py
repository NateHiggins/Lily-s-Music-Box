"""Matched one-census full-building run using the same complete material observer."""
...
NAME = 'material_one_census_v1_full_01'
RUN = ROOT / 'design/astra/evidence/vulkan_composed/runs' / NAME
OUT = ROOT / 'design/astra/evidence/composed_material_ownership/one_census_outer_01'
