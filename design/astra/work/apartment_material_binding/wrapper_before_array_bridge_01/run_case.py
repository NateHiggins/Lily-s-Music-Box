...
def main():
    ...
    command = powershell_file_command(RUNNER, ['-ProjectPath', ROOT / 'game',
        '-Scene', SCENE, '-LogPath', log, '-TimeoutSeconds', args.timeout, '-ExtraArgs', '--verbose'])
    ...
    receipt = {'schema': 'astra.apartment_material_binding.runtime.v3', 'name': args.name,
