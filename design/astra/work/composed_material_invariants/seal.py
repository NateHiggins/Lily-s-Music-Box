...
receipt = {"status": "PREPARED_ONLY_NO_LIVE_GAME_INSTALL_NO_ENGINE",
           ...
           "pure_controls": {"command": command, "exit": run.returncode, "tests": 24},
           ...
           "source_review": ["Exact original transition method and all original assertion calls retained",
                             ...
                             "All six unit expectations match independent shipped case data; Peter is4A",
                             "Unsafe initial threshold/active beachhead state refuses before mutation; exact actual beachhead draw identities recorded before/during/after",
...
print(json.dumps({"status": receipt["status"], "tests": 24, "exit": run.returncode,
