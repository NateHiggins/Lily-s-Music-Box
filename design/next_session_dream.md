...
FA1 and FA2 are now complete as separate presentation slices. Gilder's Buttons,
Tessellates, Wine Anemones, Ribbonettes and one harmless Loupe derive from the
live pocket, real lineage birth-frames, exposure, lamp and Tenant position
through one fixed-3-Hz four-density owner. They add five shadowless batches,
no collision/light/hazard/save owner, and pass the ruled performance ceiling.
Proof: `art/renders/dream_fauna_fa2/README.md`. FA3–FA4 remain gated.
