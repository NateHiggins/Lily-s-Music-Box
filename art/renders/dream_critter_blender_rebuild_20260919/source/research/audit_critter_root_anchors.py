...
expected={4:12,6:12,7:6,8:36,10:1,11:12,12:2,15:12}
...
invalid_positive=[index for index,(identifier,weight) in bindings.items() if weight>1e-7 and (abs(identifier-round(identifier))>1e-6 or not -1-args.count<=identifier<=-2)]
records=[]
