...
def _surface(u,phi):
    ...
    z_radius=.455*math.sin(theta)*(1.-blend)+.350*blend
    ...
    return (x_radius*math.cos(phi),y,z_radius*math.sin(phi))
...
def build_objects(api,col,lod,seed):
    ...
    for cell in range(CELL_COUNT):
        ...
        others.append(api.make_object("Frustule_%02d"%cell,_jacket(api,cell,lod),col,0,"silica_frustule"))
        for flank in (-1,1):
