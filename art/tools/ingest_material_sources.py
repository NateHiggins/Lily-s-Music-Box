...
SLOTS = {
    "common_brick_interior": (["common_brick", "brick_patched"],
                              2.4, 0.88, 0.10, 7.0),
    "face_brick_street": (["face_brick", "brick"], 2.4, 0.82, 0.10, 7.0),
    "limestone_carved": (["limestone"], 1.6, 0.78, 0.10, 4.0),
    "floor_oak_worn": (["floor_oak"], 2.0, 0.55, 0.25, 3.5),
    "terrazzo_lobby": (["terrazzo"], 2.0, 0.38, 0.18, 2.0),
    "stair_marble_worn": (["stair"], 1.2, 0.45, 0.20, 3.0),
    "wainscot_beadboard": (["wainscot"], 1.8, 0.58, 0.15, 5.0),
    "trim_painted_layers": (["trim", "baluster"], 0.4, 0.52, 0.18, 3.5),
    "ceramic_hex_bath": (["ceramic"], 1.0, 0.42, 0.22, 4.5),
    "subway_tile_aged": (["subway_tile"], 1.2, 0.28, 0.20, 4.5),
    "concrete_cellar": (["concrete", "slab"], 2.0, 0.86, 0.08, 3.0),
    "timber_joist": (["timber"], 1.0, 0.80, 0.12, 5.0),
    "brass_aged": (["brass"], 0.25, 0.40, 0.25, 2.0),
    "enamel_appliance": (["appliance"], 0.5, 0.22, 0.15, 1.5),
    ...
    "linoleum_kitchen": (["linoleum"], 1.5, 0.50, 0.20, 2.0),
    ...
    "tin_ceiling": (["tin_ceiling"], 1.5, 0.45, 0.20, 6.0),
